...
configdata={"flock_size":flock_size,"formation_flying_distance":formation_flying_distance,
...
config_file=open(file_to_write_to,'w')
config_file.write(yaml.dump(configdata))
config_file.close()
